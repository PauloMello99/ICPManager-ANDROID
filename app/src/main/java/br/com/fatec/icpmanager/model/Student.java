...
public class Student implements Serializable {
    ...
    public Student(String id, String name, String gender, String birthDate, String picture,
                   String email, String facebookUrl, String skypeUrl,
                   String university, boolean enable) {
        this.id = id;
        this.name = name;
        this.gender = gender;
